...
load_from = 'work_dirs/cowfig-ft2-02/epoch_200.pth'
...
#    dict(type='CosineAnnealingLR', eta_min_ratio=1/20, by_epoch=True, begin=5, end=200, convert_to_iter_based=True) # Changed end to 50
]
...
work_dir = './work_dirs/cowfig-premiers10'
